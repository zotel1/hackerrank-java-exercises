...
*
* Enm este caso debemos usar System.out.printf() para formatear la salida correctamente
* - %-15s → s1 (string) se justifica a la izquierda y ocupa 15 caracteres.
  - %03d → x (entero) siempre ocupa 3 dígitos, rellenando con ceros a la izquierda si es necesario.
  - %n → Nueva línea. */
